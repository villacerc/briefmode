...
from app.services.helpers import retry_with_backoff, GPT_MODEL, validate_interpretation_json
import os
import json
...
class DictionaryService:
    ...
    async def get_dictionary_entry(self, input: str):
        interpretation = await self.fetch_ai_input_interpretation(input)

        return interpretation

    async def fetch_ai_input_interpretation(self, input: str):
        parsed_json = None
        max_retries = 3
